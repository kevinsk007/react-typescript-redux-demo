...
import { actions as searchActions } from '../../redux/search/actions'
...
const getRelatedKeywords = state => {
  ...
  return relatedKeywords.ids.map(id => {
    return state.search.keywords[id]
  })
}

const getInputText = state => {
  return state.search.inputText
}

const getPopularKeywords = state => {
  return state.search.popularKeywords.ids.map(id => {
    return state.search.popularKeywords.data[id]
  })
}
const getHistoryKeywords = state => {
