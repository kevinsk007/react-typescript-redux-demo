    ...
    return (
      <header className="banner" style={style}>
        ...
        <div className="banner__btns">
          <a className="banner__btn" href="https://evt.dianping.com/synthesislink/6702.html">
            打开大众点评
          </a>
          <a className="banner__btn banner__btn--bg" href="https://m.dianping.com/download/redirect?id=11186">
            下载APP享特价
          </a>
        </div>
      </header>
