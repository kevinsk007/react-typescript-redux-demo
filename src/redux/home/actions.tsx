...
export const actions = {
  ...
  loadLikes: () => {
    return (dispatch, getState) => {
      ...
      const endpoint = Api.getProductList(params.PATH_LIKES, rowIndex, params.PAGE_SIZE_LIKES)
  ...
  loadDiscounts: () => {
    return (dispatch, getState) => {
      const endpoint = Api.getProductList(params.PATH_DISCOUNTS, 0, params.PAGE_SIZE_DISCOUNTS)
